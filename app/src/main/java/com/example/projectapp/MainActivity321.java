...
public class MainActivity321 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = LocaleHelper.setLocale(MainActivity321.this, language);
        ...
        textView5.setText(resources.getString(R.string.second_info321));
        ...
        buttonPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity321.this,MainActivity321Play.class);
